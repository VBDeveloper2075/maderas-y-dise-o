    ...
    <section id="contacto" className="py-24 bg-white">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
        ...
        <p className="text-neutral-600 mb-12">
          Ubicados en Tres de Febrero, Zona Oeste. Atendemos consultas por WhatsApp y email.
        </p>
        ...
        <div className="space-y-6 mb-12">
          <div className="flex items-center justify-center gap-3 text-neutral-700">
            ...
            <span>Tres de Febrero, Buenos Aires</span>
          </div>
          <a
            href={`mailto:${EMAIL}`}
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-[#25D366] text-white font-medium rounded-sm hover:bg-[#20BD5A] transition-all shadow-lg hover:shadow-xl"
        >
